let g:coc_global_extensions = ['coc-json', 'coc-git', 'coc-css', 'coc-tsserver', 'coc-prettier', 'coc-cssmodules', 'coc-html', 'coc-rust-analyzer', 'coc-sh', 'coc-solargraph', 'coc-yaml', 'coc-svg', 'coc-toml', 'coc-swagger', 'coc-spell-checker', 'coc-eslint']
